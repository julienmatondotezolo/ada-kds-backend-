...
app.get("/health", (_req, res) => {
  res.json({
    status: "ok",
    service: "ada-kds-backend",
    version: "1.0.0",
    uptime: Math.floor((Date.now() - startTime) / 1000),
    timestamp: new Date().toISOString(),
    api_url: "https://api-kds.adasystems.app"
  });
});
...
server.listen(PORT, () => {
  ...
  console.log(`   Health:    https://api-kds.adasystems.app/health`);
  console.log(`   API:       https://api-kds.adasystems.app/api/v1`);
  console.log(`   📚 Docs:   https://api-kds.adasystems.app/api-docs`);
